...
export default {
  ...
  computed: {
    status: {
      get() {
        return this.$store.getters.getRepostingSteps.fillIn_isResumeRequired;
      },
    },
    failureMsg: {
      get() {
        return this.$store.getters.getFailureMsgs.fillIn_isResumeRequired;
      },
    },
  },
  methods: {
    execute() {
      this.$store.dispatch("execute_fillIn_isResumeRequired");
    },
  },
};
</script>
