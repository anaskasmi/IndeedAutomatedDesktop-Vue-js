...
export default {
  ...
  computed: {
    status: {
      get() {
        return this.$store.getters.getRepostingSteps.fillIn_salaryFromAndTo;
      },
    },
    failureMsg: {
      get() {
        return this.$store.getters.getFailureMsgs.fillIn_salaryFromAndTo;
      },
    },
  },
  methods: {
    execute() {
      this.$store.dispatch("execute_fillIn_salaryFromAndTo");
    },
  },
};
</script>
