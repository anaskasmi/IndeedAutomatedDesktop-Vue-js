...
export default {
  ...
  computed: {
    status: {
      get() {
        return this.$store.getters.getRepostingSteps.click_advanced;
      },
    },
    failureMsg: {
      get() {
        return this.$store.getters.getFailureMsgs.click_advanced;
      },
    },
  },
  methods: {
    execute() {
      this.$store.dispatch("execute_click_advanced");
    },
  },
};
</script>
