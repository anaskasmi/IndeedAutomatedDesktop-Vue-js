...
export default {
  ...
  methods: {
    async fillInPage() {
      this.isLoading = true;
      try {
        await this.$store.dispatch("execute_click_advanced");
        await this.$store.dispatch("execute_fillIn_adDurationType");
        await this.$store.dispatch("execute_fillIn_adDurationDate");
        await this.$store.dispatch("execute_fillIn_CPC");
        await this.$store.dispatch("execute_fillIn_adBudget");
