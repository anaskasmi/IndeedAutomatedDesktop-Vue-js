...
export default {
  ...
  computed: {
    description: {
      get() {
        return this.$store.getters['repostPageModule/getCurrentJob'].jobDescriptionHtml;
      },
    },
    status: {
      get() {
        return this.$store.getters['repostPageModule/getRepostingSteps'].fillIn_description;
      },
    },
    failureMsg: {
      get() {
        return this.$store.getters['repostPageModule/getFailureMsgs'].fillIn_description;
      },
    },
  },
  methods: {
    execute() {
      this.$store.dispatch("repostPageModule/execute_fillIn_description");
    },
    onCopy() {
