            ...
            <div class="row justify-content-around">
              ...
              <div class="my-auto col">
                ...
                <div class="text-left mt-2">
                  ...
                  <span v-if="job.location && job.country" class="text-secondary mx-1">{{ job.location + " " + job.country
                  }}
                  </span>
              ...
              <v-card-text class="my-4">
                ...
                <div class="mt-5">
                  <div class="row col-12 justify-content-around">
                    <budgetPanel title="Amount" :value="'$' + job.budget_amount / 100" />
                    <budgetPanel title="Display cost" :value="job.budget_cost / 100" />
              ...
              <v-card-text class="my-4">
                ...
                <div class="text-muted pa-5 mt-5 shadow-sm border border-dark" style="
                  ...
                  <div class="text-muted pa-5 mt-5 shadow-sm border border-dark" style="
                    background-color: #faf8f8;
                    text-align: justify;
                  " v-html="job.descriptionHtml"></div>
